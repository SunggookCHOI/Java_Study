...
import model.domain.CustomerDB;
import model.domain.StockDB;
...
public class Service {
	...
	public Clothes getClothes (String name) {
		...
		logger.info("fail to find product"+name);
		return null;
	}
...
//			System.out.println(Integer.parseInt(sizes.get(sizes.indexOf(size))));
	...
	public ArrayList<Customer> searchCustomerWhoBought(String clothes) throws NotExistException{
		...
		if (found.size()>0) {
			...
			throw new NotExistException("해당 제품을 구매한 고객이 없습니다");
		}
	}
